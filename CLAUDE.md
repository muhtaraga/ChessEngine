...
Motor UCI üzerinden GUI'ye bağlanıyor, legal oynuyor, perft geçiyor. Toplam 97
...
LMR + futility ailesi + LMP + razoring TAMAM (hepsi SPRT'den geçti). **Sıradaki:
extensions (check extension).** Ayrıntılı adım-adım kayıt ve en güncel özet
...
+ razoring (Adım 7, +16.5 Elo) TAMAM, hepsi SPRT'den geçti. Sonraki: extensions
(check extension + ileride singular).** Tapered eval (+42.8), pawn structure
...
(hepsi TAMAM) -> **extensions (sıradaki)**. Her biri ayrı commit. NOT: PVS
